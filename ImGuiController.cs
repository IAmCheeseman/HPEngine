...
public class ImGuiController : IDisposable
{
    ...
    /// </summary>
    public ImGuiController(Context engineContext, int width, int height)
    {
    ...
    private void UpdateImGuiInput()
    {
        ...
        MouseState MouseState = _context.Window.Handle.MouseState;
        KeyboardState KeyboardState = _context.Window.Handle.KeyboardState;
